...
try {
    logMessage("=== Начало обработки save_settings_debug.php ===");
    ...
    // Получаем и валидируем только те поля, которые есть в форме
    ...
    try {
        // Обновляем только те поля, которые есть в форме
...
logMessage("=== Завершение обработки save_settings_debug.php ===");
exit;
?>