                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="about_text" rows="4" placeholder="Расскажите о себе, своем опыте и навыках..."><?php echo htmlspecialchars($settings['about_text']); ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Лет опыта</label>
                                <input type="number" class="form-control" name="experience_years" value="<?php echo htmlspecialchars($settings['experience_years'], ENT_QUOTES, 'UTF-8'); ?>">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Проектов выполнено</label>
                                <input type="number" class="form-control" name="projects_count" value="<?php echo htmlspecialchars($settings['projects_count'], ENT_QUOTES, 'UTF-8'); ?>">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Клиентов</label>
                                <input type="number" class="form-control" name="clients_count" value="<?php echo htmlspecialchars($settings['clients_count'], ENT_QUOTES, 'UTF-8'); ?>">
                            </div>
                        </div>
                    </div>
